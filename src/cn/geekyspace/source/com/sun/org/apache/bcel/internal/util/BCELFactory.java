...
class BCELFactory extends EmptyVisitor {
    ...
    private void updateBranchTargets() {
        for(BranchInstruction branchInstruction : branches) {
            final BranchHandle bh = (BranchHandle) branchMap.get(branchInstruction);
            final int pos = bh.getPosition();
            final String name = branchInstruction.getName() + "_" + pos;
            ...
            if (branchInstruction instanceof Select) {
                final InstructionHandle[] ihs = ((Select) branchInstruction).getTargets();
